...
import (
	...
	"crypto/rand"
	"encoding/hex"
	session2 "tennis-league/user-service/internal/service/session"
	"time"
...
func (r *SessionRepository) Start(ctx context.Context, startSessionInput *session2.StartSessionInput) (*dto.Session, error) {
